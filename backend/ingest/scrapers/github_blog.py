...
class GitHubBlogScraper(BaseScraper):
    ...
    def _try_rss(self) -> list[dict]:
        ...
        for page in range(1, self._max_pages + 1):
            ...
            logger.info("Trying GitHub Blog RSS feed page %d: %s", page, paged_url)
        ...
        logger.info("Parsed %d total entries from GitHub Blog RSS", len(all_results))
        return all_results
    ...
    def _try_html(self) -> list[dict]:
        ...
        for page in range(1, self._max_pages + 1):
            ...
            logger.info("Scraping GitHub Blog HTML page %d: %s", page, page_url)
            try:
        ...
        logger.info("Parsed %d total entries from GitHub Blog HTML", len(all_results))
        return all_results
